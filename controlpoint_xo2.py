...
class ControlPoint_XO2:
  ...
  def lineRoute(self, entranceSignal):
    ...
    print("CP [%s] sigrole [%s] e_xover=%s/%s  w_xover=%s/%s" % (self.name, reqSignalRole, self.switches['switch_e_xover_1'].positionNormal, self.switches['switch_e_xover_1'].positionReverse, self.switches['switch_w_xover_1'].positionNormal, self.switches['switch_w_xover_1'].positionReverse))
...
#                              O-| <-M1E
    ...
    if reqSignalRole == 'main_1_w' and self.switches['switch_w_xover_2'].positionReverse:
...
#                              O-| <-M1E
  ...
  def recalculateStateReal(self):
    ...
    if self.sensors['main_1_e'].getState():
      ...
      elif self.switches['switch_w_xover_1'].positionReverse and self.switches['switch_w_xover_2'].positionReverse:
        self.lockAllSwitches()
        self.signals['main_1_w'].setIndication(False, False)
        self.signals['main_1_e'].setIndication(True, False)
    ...
    if self.sensors['main_2_e'].getState():
      ...
      if (self.switches['switch_e_xover_2'].positionNormal and self.switches['switch_w_xover_2'].positionNormal) or (self.switches['switch_e_xover_2'].positionReverse and self.switches['switch_w_xover_2'].positionReverse):
        ...
        self.clearRouteTrace('main_2')
      # If we're lined to main one via the XOVER
      elif (self.switches['switch_e_xover_2'].positionReverse or self.switches['switch_w_xover_2'].positionReverse) and not (self.sensors['main_1_w'].getState() or self.sensors['main_1_e'].getState()):
        self.lined['main_1'] = 'none'
        self.lined['main_2'] = 'none'
        self.clearRouteTrace('main_1')
        self.clearRouteTrace('main_2')
